...
export default function TagManager() {
  ...
  return <main className="sf-report"><header className="flex items-center gap-3 py-3"><button aria-label="返回設定" className="text-primary" onClick={() => navigate('/settings')}><ChevronLeft /></button><h1 className="text-xl font-semibold">標籤管理</h1></header>
